...
/**
 * Fetches the grade distribution data from the API.
 *
 * @param academicPeriodId - The ID of the academic period to filter by (optional).
 * @param departmentId - The ID of the department to filter by (optional).
 * @param binSize - The size of the bins for grade distribution (optional).
 * @returns A promise that resolves to a ResponseAPI containing GradeDistributionData.
 */
export default function getGradeDistribution(
  ...
  return api.get('/stats/distribution/grades', { params })
}
