...
const DIRECTOR_NAV: NavItem[] = [
  ...
  { id: 'matrix', label: 'Matriz Evaluación', icon: BarChart3, href: '/matrix' },
  { id: 'plans', label: 'Planes de Mejoramiento', icon: TrendingUp, href: '/plans' },
  { id: 'docs', label: 'Documentos', icon: FileText, href: '#' },
]

const ADMIN_NAV: NavItem[] = [
  { id: 'directors', label: 'Subir directores', icon: UserSearch, href: '/admin/directors' },
  { id: 'periods', label: 'Periodos académicos', icon: Calendar, href: '/admin/periods' },
  { id: 'logs', label: 'Logs del sistema', icon: FileText, href: '/admin/logs' },
]
...
export const ROLE_SUBTITLE: Record<AppRole, string> = {
  director: 'v2.1 · Director',
  admin: 'v2.1 · Super Admin',
  teacher: 'v2.1 · Docente',
}
